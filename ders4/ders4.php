...
echo "<h3>dizinin içeriğinin foreach döngsü ile yazdırılması-1<h3>";
...
echo "<h3>dizinin içeriğinin foreach döngsü ile yazdırılması-2<h3>";

foreach ($dizi1 as $key => $value) {
    echo" $key - $value <br>";
}

echo "<h3>dizinin içeriğinin for döngsü ile yazdırılması-3<h3>";
...
echo "sayıalar dizisini içerisindeki 2. dizinin 3.elemanı: " . $sayilar[1][3];
echo "<br>sayıalar dizisini içerisindeki 1. dizinin 4.elemanı: " . $sayilar[0][4];
...
echo "sayıalar dizisini içerisindeki 1. dizinin 1 indisli elemanı: " . $sayilar["integer"][1];
echo "<br>sayıalar dizisini içerisindeki 1. dizinin 2 indisli elemanı: " . $sayilar["double"][2];
